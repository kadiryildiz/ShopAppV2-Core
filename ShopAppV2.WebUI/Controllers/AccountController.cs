...
{
    [AutoValidateAntiforgeryToken] // ValidateAntiforgeryToken ile post methodlarında yada Auto ile de otomatik tüm post işlemlerinde kullanılabilir.
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                // send email
                await _emailSender.SendEmailAsync(model.Email, "Hesabınızı Onaylayınız.", $"Lütfen email hesabınızı onaylamak için linke <a href='http://localhost:32869{callbackUrl}'>tıklayınız.</a>");

                TempData.Put("message", new ResultMessage() // Extensions-> TempDataExtensions eklendi.
                {
                    Title = "Hesap Onayı",
        ...
        public async Task<IActionResult> ForgotPassword(string Email)
        {
            ...
            // send email
            await _emailSender.SendEmailAsync(Email, "Reset Password", $"Parolanızı yenilemek için linke <a href='http://localhost:32869{callbackUrl}'>tıklayınız.</a>");
